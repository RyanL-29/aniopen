...
document.write('<link rel="manifest" href="//cdn.jsdelivr.net/gh/RyanL-29/aniopen@1.5.9/manifest.json">');
...
// DPlayer API
document.write('<script src="//cdn.jsdelivr.net/gh/RyanL-29/aniopen@1.5.9/DPlayer.min.js"></script>');
...
function nav(path) {
    ...
    if (arr.length > 0) {
        ...
        if (!window.location.href.includes("?a=view") || !path.includes("/DMCA") || !path.includes("/ContactUs")) {
