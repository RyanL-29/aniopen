...
document.write('<script src="https://cdn.jsdelivr.net/gh/redbullzuiper/SRT-Support-for-HTML5-videos/srt2vtt.min.js"></script>');
document.write('<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/ionicons@2.0.1/css/ionicons.min.css">');
document.write('<link rel="manifest" href="https://cdn.jsdelivr.net/gh/RyanL-29/aniopen@1.7.51/manifest.json">');
...
// DPlayer API
document.write('<script src="//cdn.jsdelivr.net/gh/RyanL-29/aniopen@1.7.51/DPlayer.min.js"></script>');
...
function file_video(path) {
    ...
    var vlc = 'vlc:' + share2;
    share2 = 'https:' + share2 + "?a=view";
    var playBtn = `<button class="mdui-btn mdui-btn-raised mdui-ripple mdui-color-deep-purple-900" href="${vlc}" target="_blank"><i class="mdui-icon material-icons">&#xe038;</i> 在 VLC media player 中播放</button>`;
