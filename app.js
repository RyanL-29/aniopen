...
document.write('<link rel="manifest" href="//cdn.jsdelivr.net/gh/RyanL-29/aniopen@1.6.2/manifest.json">');
...
// DPlayer API
document.write('<script src="//cdn.jsdelivr.net/gh/RyanL-29/aniopen@1.6.2/DPlayer.min.js"></script>');
...
function nav(path) {
    ...
    if (arr.length > 0) {
        ...
        else if (path == '/DMCA' || path == '/ContactUs')
        {
