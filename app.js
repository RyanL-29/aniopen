...
document.write('<link rel="manifest" href="//cdn.jsdelivr.net/gh/RyanL-29/aniopen@1.5.2/manifest.json">');
...
// DPlayer API
document.write('<script src="//cdn.jsdelivr.net/gh/RyanL-29/aniopen@1.5.2/DPlayer.min.js"></script>');
...
<div class="mdui-dialog" id="dialog">
  ...
  <footer>
    ...
    <p class="footer-ele"><a onclick="contactus(); topFunction();">聯絡我們</a></p><ins></ins>
    <p class="footer-ele"><a onclick="dmca(); topFunction();">DMCA</a></p>
    </div>
